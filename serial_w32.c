				  ...
				  struct port_options *ops)
{
	...
	/* Bug fix by Roger Clark (http://www.rogerclark.net) for COM port numbers greater than COM9, number of digits can be 4 for COM0 to COM9 or 5 for COM10 to COM99 */
